...
const quizData = {
  ...
  17: { question: 'オランダの首都はどこ？', options: ['アムステルダム', 'ロッテルダム', 'ユトレヒト', 'デンハーグ'], answer: 0, explanation: 'オランダの首都はアムステルダムです！' },
  ...
  33: { question: 'アメリカ合衆国の首都はどこ？', options: ['ワシントンD.C.', 'ニューヨーク', 'ロサンゼルス', 'シカゴ'], answer: 0, explanation: 'アメリカ合衆国の首都はワシントンD.C.です！' },
  34: { question: 'カナダの首都はどこ？', options: ['モントリオール', 'トロント', 'バンクーバー', 'オタワ'], answer: 3, explanation: 'カナダの首都はオタワです！' },
  35: { question: 'オーストラリアの首都はどこ？', options: ['メルボルン', 'シドニー', 'カンベラ', 'ブリスベン'], answer: 2, explanation: 'オーストラリアの首都はカンベラです！' },
  36: { question: 'ニューカレドニアの首都はどこ？', options: ['ヌクアルファル', 'サンフアン', 'ナッシュビル', 'ポートオブスペイン'], answer: 0, explanation: 'ニューカレドニアの首都はヌクアルファルです！' },
  37: { question: 'フィジーの首都はどこ？', options: ['ソロモン', 'ナウル', 'ノルウェー', 'フィジー'], answer: 3, explanation: 'フィジーの首都はフィジーです！' },
  38: { question: 'トンガの首都はどこ？', options: ['ヌクアルファル', 'サンフアン', 'ナッシュビル', 'ポートオブスペイン'], answer: 0, explanation: 'トンガの首都はヌクアルファルです！' },
  39: { question: 'パプアニューギニアの首都はどこ？', options: ['アバリ', 'モロボイ', 'ポートモレスビー', 'カナダ'], answer: 2, explanation: 'パプアニューギニアの首都はポートモレスビーです！' },
};
