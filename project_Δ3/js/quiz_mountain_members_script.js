...
const quizData = {
  ...
  22: { question: '笠ヶ岳山荘から見える絶景として有名なのは？', options: ['白山連峰', '槍・穂高連峰の稜線', '立山連峰', '乗鞍岳'], answer: 1, explanation: '笠ヶ岳山荘からは槍ヶ岳から穂高連峰に続く稜線が一望できます！' },
...
function goToResult() {
  ...
  const currentStage = urlParams.get('stage') || '2'; // デフォルトを2にする

  localStorage.setItem('membersStageUrl', 'quiz_mountain_members.html?stage=' + currentStage);
