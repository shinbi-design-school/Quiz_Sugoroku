...
const quizData = {
  ...
  17: { question: 'オランダの首都はどこ？', options: ['アムステルダム', 'ロッテルダム', 'ハーグ', 'ユトレヒト'], answer: 0, explanation: 'オランダの首都はアムステルダムです！' },
  ...
  36: { question: 'オーストラリアの首都はどこ？', options: ['メルボルン', 'シドニー', 'キャンベラ', 'ブリスベン'], answer: 2, explanation: 'オーストラリアの首都はキャンベラです！' },
...
function goToResult() {
  ...
  localStorage.setItem('membersStageUrl', 'world_members.html?stage=' + currentStage);
