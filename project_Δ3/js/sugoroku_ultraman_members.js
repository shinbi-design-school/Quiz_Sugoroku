...
const quizData = {
  ...
  9: { 
    ...
    options: ['最もスピードが高い', '最も防御力が高い', '最もパワーが高い', '最もバランスがいい'],
    answer: 3,
    explanation: '<ul><li>フラッシュタイプは能力のバランスがいい。</li></ul>'
  },
...
function goToResult() {
  ...
  const currentStage = urlParams.get('stage') || '3'; 

  localStorage.setItem('membersStageUrl', 'sugoroku_ultraman_member.html?stage=' + currentStage);
