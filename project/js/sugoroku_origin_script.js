...
const masterData = [
  ...
  { type: 'normal',   name: '浅草',       icon: '⛩️' },
  { type: 'normal',   name: 'スカイツリー', icon: '🗼' },
  { type: 'quiz',     name: '東京クイズ', icon: '❓', quizId: 1 },
  { type: 'positive', name: '東京駅',      icon: '🚉', effect: 2 },
  { type: 'normal',   name: '銀座',       icon: '🏬' },
  { type: 'hapning',  name: '渋滞',       icon: '🚗', effect: -2 },
  { type: 'normal',   name: '渋谷',       icon: '🐕' },
  { type: 'quiz',     name: '東京クイズ', icon: '❓', quizId: 2 },
  { type: 'normal',   name: '原宿',       icon: '👘' },
  { type: 'positive', name: '新宿',       icon: '🏙️', effect: 3 },
  { type: 'normal',   name: '池袋',       icon: '🦉' },
  { type: 'hapning',  name: '道に迷う',    icon: '😵', effect: -1 },
  { type: 'normal',   name: '上野',       icon: '🐼' },
  { type: 'quiz',     name: '東京クイズ', icon: '❓', quizId: 3 },
  { type: 'normal',   name: '秋葉原',     icon: '🎮' },
  { type: 'positive', name: '東京タワー',  icon: '🗼', effect: 2 },
  { type: 'normal',   name: 'お台場',     icon: '🌉' },
  { type: 'normal',   name: '六本木',     icon: '🌃' },
  { type: 'normal',   name: '丸の内',     icon: '🏢' },
  { type: 'normal',   name: '品川',       icon: '🚄' },
  { type: 'positive', name: '恵比寿',     icon: '🍺', effect: 1 },
  { type: 'normal',   name: '代々木',     icon: '🌲' },
  { type: 'hapning',  name: '電車遅延',    icon: '⚡', effect: -1 },
  { type: 'normal',   name: '両国',       icon: '🏯' },
  { type: 'quiz',     name: '東京クイズ', icon: '❓', quizId: 1 },
  { type: 'normal',   name: '墨田',       icon: '🎆' },
  { type: 'positive', name: '神田',       icon: '📚', effect: 2 },
  { type: 'normal',   name: '日本橋',     icon: '🌉' },
  { type: 'hapning',  name: '忘れ物',     icon: '🎒', effect: -2 },
  { type: 'normal',   name: '築地',       icon: '🍣' },
  { type: 'normal',   name: '有楽町',     icon: '🎭' },
  { type: 'quiz',     name: '東京クイズ', icon: '❓', quizId: 2 },
  { type: 'normal',   name: '表参道',     icon: '✨' },
  { type: 'positive', name: '青山',       icon: '🎨', effect: 1 },
  { type: 'normal',   name: '赤坂',       icon: '🏛️' },
  { type: 'normal',   name: '永田町',     icon: '🏢' },
  { type: 'hapning',  name: '工事中',     icon: '🚧', effect: -1 },
  { type: 'normal',   name: '霞ヶ関',     icon: '⚖️' },
  { type: 'quiz',     name: '東京クイズ', icon: '❓', quizId: 3 },
  { type: 'normal',   name: '目黒',       icon: '🐟' },
  { type: 'positive', name: '中目黒',     icon: '🌸', effect: 2 },
  { type: 'normal',   name: '五反田',     icon: '🏙️' },
  { type: 'normal',   name: '大崎',       icon: '🌆' },
  { type: 'hapning',  name: '雨',         icon: '☔', effect: -1 },
  { type: 'normal',   name: '高輪',       icon: '🚪' },
  { type: 'normal',   name: '田町',       icon: '🏗️' },
  { type: 'positive', name: '浜松町',     icon: '🚢', effect: 1 },
  { type: 'normal',   name: '新橋',       icon: '🍻' },
];
